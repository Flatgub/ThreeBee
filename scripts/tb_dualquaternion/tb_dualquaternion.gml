...
function dq_create(radians, ax, ay, az, x, y, z) 
{
...
/// @func dq_create_from_matrix(M, targetDQ)
function dq_create_from_matrix(M, DQ) 
{	
...
function dq_get_translation(DQ) 
...
function dq_lerp(DQ1, DQ2, amount, targetDQ) 
{
	var R = DQ1;
	var S = DQ2;
	var v2 = amount;
...
function dq_multiply(R, S, targetDQ) {
	//Multiplies two dual quaternions and outputs the result to target
	//R * S = (A * C, A * D + B * C)
	var T = targetDQ;
	var _r0 = R[0], _r1 = R[1], _r2 = R[2], _r3 = R[3], _r4 = R[4], _r5 = R[5], _r6 = R[6], _r7 = R[7];
	var s0 = S[0], s1 = S[1], s2 = S[2], s3 = S[3], s4 = S[4], s5 = S[5], s6 = S[6], s7 = S[7];
	var Qx = _r3 * s0 + _r0 * s3 + _r1 * s2 - _r2 * s1;
	var Qy = _r3 * s1 + _r1 * s3 + _r2 * s0 - _r0 * s2;
	var Qz = _r3 * s2 + _r2 * s3 + _r0 * s1 - _r1 * s0;
	var Qw = _r3 * s3 - _r0 * s0 - _r1 * s1 - _r2 * s2;
	var Dx = _r3 * s4 + _r0 * s7 + _r1 * s6 - _r2 * s5 + _r7 * s0 + _r4 * s3 + _r5 * s2 - _r6 * s1;
	var Dy = _r3 * s5 + _r1 * s7 + _r2 * s4 - _r0 * s6 + _r7 * s1 + _r5 * s3 + _r6 * s0 - _r4 * s2;
	var Dz = _r3 * s6 + _r2 * s7 + _r0 * s5 - _r1 * s4 + _r7 * s2 + _r6 * s3 + _r4 * s1 - _r5 * s0;
	var Dw = _r3 * s7 - _r0 * s4 - _r1 * s5 - _r2 * s6 + _r7 * s3 - _r4 * s0 - _r5 * s1 - _r6 * s2;
	T[@ 0] = Qx;
	T[@ 1] = Qy;
	T[@ 2] = Qz;
	T[@ 3] = Qw;
...
function dq_quadratic_interpolate(A, B, C, amount, targetDQ) 
{
...
function dq_set_translation(DQ, x, y, z) 
{
...
function dq_to_matrix(_dq) {
	gml_pragma("forceinline")
	return mat_create_from_dualquat(_dq)
	}